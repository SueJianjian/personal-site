            ...
            <div className="max-w-2xl text-white">
              ...
              <div className="mt-12 flex flex-col gap-5 sm:flex-row">
                ...
                >
                  ...
                  <span className="cta-pill cta-pill-icon" aria-hidden="true">
                    <svg viewBox="0 0 24 24" className="h-5 w-5 fill-current">
                      <path d="M9.42 5.5c-4.21 0-7.62 2.67-7.62 5.96 0 1.9 1.14 3.59 2.91 4.68l-.74 2.39 2.78-1.38c.82.16 1.74.25 2.67.25 4.21 0 7.62-2.67 7.62-5.94S13.63 5.5 9.42 5.5Zm-2.96 4.85a.88.88 0 1 1 0-1.76.88.88 0 0 1 0 1.76Zm5.92 0a.88.88 0 1 1 0-1.76.88.88 0 0 1 0 1.76Z" />
                      <path d="M17.23 10.38c-.25 0-.5.02-.73.05 1.2.91 1.95 2.22 1.95 3.68 0 2.73-2.64 4.94-5.9 4.94-.34 0-.66-.02-.98-.08l-2.1 1.05.55-1.76c-1.1-.67-1.84-1.69-2.07-2.86.48.06.97.11 1.47.11 4.98 0 9.01-3.17 9.01-7.08 0-.66-.11-1.29-.34-1.9 2.64.33 4.68 2.1 4.68 4.25 0 1.26-.72 2.38-1.84 3.13l.48 1.55-1.84-.91c-.44.08-.9.13-1.34.13-.36 0-.72-.03-1.07-.08 1.2-.78 1.97-1.97 1.97-3.3 0-2.37-2.38-4.3-5.31-4.3Z" />
                    </svg>
                  </span>
                </a>
              </div>
